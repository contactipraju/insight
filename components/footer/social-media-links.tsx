...
export default function SocialMediaLinks({}: any) {
	return (
		<div className="flex gap-2 p-6">
			...
			<a className="shrink-0 rounded-lg p-1 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://www.instagram.com/investorpro.ba" target="_blank">
			...
			<a className="shrink-0 rounded-lg p-1 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://x.com/investorpro_ba" target="_blank">
			...
			<a className="shrink-0 rounded-lg p-1 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://www.linkedin.com/company/investorproba" target="_blank">
