	...
	<>
		<div className="privacy-content overflow-hidden">
			<div className="prose mx-auto max-w-screen-md px-6 lg:prose-lg md:pb-24 body">
				...
				<ul>
					<li><strong>Personal Identification Details:</strong> Name, contact information (email, phone number, address etc), and details required for agency agreements.</li>
					<li><strong>Property Search Criteria:</strong> Information related to your property preferences and requirements.</li>
					<li><strong>Financial Information:</strong> Existing property portfolio details, Income, Purchase agreements and related documentation.</li>
				...
				<ul>
					<li><strong>To Provide Services:</strong> To assist you in stratagizing, finding, purchasing property, and processing transactions.</li>
				...
				<p><strong>8. Opting out of communication</strong></p>
				<p>You can unsubscribe from marketing communication at any time.</p>
				<p><strong>9. Complaints and Contact</strong></p>
				...
				<p><strong>11. Effective Date</strong></p>
