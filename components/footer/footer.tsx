...
export default function Footer({
	...
	return (
		<footer className="sticky bottom-0 overflow-hidden">
			<div className="relative bg-orange-50 grid h-screen max-h-[1200px] min-h-0 overflow-y-auto overflow-x-hidden sm:pt-32 sm:pt-16 md:max-h-[1200px] md:pt-48 lg:pt-32">
