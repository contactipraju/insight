...
const meta = {
	...
	description: "Best Buyer's Agency in Australia offering expert property buying services for your next home or investment.",
...
export default function Head() {
	...
	return (
	    <NextHead>
			...
			<meta property="og:image:alt" content="cover image for the Keystatic Marketing Landing Page Template" />
