...
export default function Hero({
	...
	return (
		...
		{/* Blob 2 */}
			...
			<div className="relative z-10 mx-auto grid desktop-page-width md:grid-cols-2 py-8 md:py-16 px-6 md:py-8 md:pb-8 lg:px-8">
				<Image
					src={heroImage}
					alt=""
				...
				<div>
					...
					<p className="mt-6 sm:mt-10 sm:text-small sm:leading-6 whitespace-pre-line">
						{heroIntroText}
					</p>
				</div>
			</div>
