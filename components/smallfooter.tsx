				...
				<div className="mx-auto flex max-w-5xl flex-col gap-4 px-6">
					<div className="flex flex-col items-center justify-between gap-2 md:flex-row md:gap-6">
						...
						<div className="flex gap-2">
							...
							<a className="shrink-0 rounded-lg p-3 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://www.instagram.com/investorpro.ba" target="_blank">
							...
							<a className="shrink-0 rounded-lg p-3 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://x.com/investorpro_ba" target="_blank">
							...
							<a className="shrink-0 rounded-lg p-3 hover:bg-slate-3 active:bg-slate-5 transition-colors w-12" href="https://www.youtube.com/@ipBuyersAgency" target="_blank">
